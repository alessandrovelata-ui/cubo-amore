...
def set_style():
    ...
    <style>
        ...
        /* Forza i bottoni a stare sulla stessa riga e ad avere stile uniforme */
        div.stButton > button { 
        ...
        /* Stile Grigio per Spegni Lampada */
        .btn-off div.stButton > button {
...
def invia_notifica(txt):
    try: requests.get(f"https://api.telegram.org/bot{st.secrets['TELEGRAM_TOKEN']}/sendMessage", params={"chat_id": st.secrets['TELEGRAM_CHAT_ID'], "text": txt}, timeout=5)
    except: pass
